...
void selectionSort(vector <int>& arr, long long& passes, long long& comparisons, long long& shifts){
    int n = arr.size();
...
void processArray(vector<int> arr, char type, int arrayNum, ofstream &fout, long long &sumPass, long long &sumCom, long long &sumShifts,int&  batchCount){
        ...
        selectionSort(arr, passes, comparisons, shifts);  //array sorted
...
int main(){
    ...
    ofstream fout("selection_results.csv");
